"""Central configuration module (migrated from root config.py)."""
...
class Config:
    ...
    def __init__(self):
        self.subfolder_names = [
            'HF_201','HF_203','HF_205','HF_207','HF_209','HF_211','HF_213','HF_215','HF_217','HF_219','HF_221','HF_223','HF_225','HF_227','HF_229','HF_231','HF_233','HF_235','HF_237','HF_239','HF_241','HF_243','HF_245','HF_247','HF_249','HF_251','HF_253','HF_255','HF_257','HF_259','HF_261','HF_263',
            'LF_202','LF_204','LF_206','LF_208','LF_210','LF_212','LF_214','LF_216','LF_218','LF_220','LF_222','LF_224','LF_226','LF_228','LF_230','LF_232','LF_234','LF_236','LF_238','LF_240','LF_242','LF_244','LF_246','LF_248','LF_250','LF_252','LF_254','LF_256','LF_258','LF_260'
        ]
        self.land = 'Med'
        self.need_norm = True
        ...
        self.parameters = [
            ...
            f'knee_X_med','knee_Y_med', f'knee_Z_med', f'pelvis_X_med', f'pelvis_Y_med', f'pelvis_Z_med',
            f'thorax_X_{self.land}', f'thorax_Y_{self.land}', f'thorax_Z_{self.land}'
        ]
